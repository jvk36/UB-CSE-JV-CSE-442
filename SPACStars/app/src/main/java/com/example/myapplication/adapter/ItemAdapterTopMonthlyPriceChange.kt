...
class ItemAdapterTopMonthlyPriceChange(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        ...
        val adapterLayout = LayoutInflater.from(parent.context)
                .inflate(R.layout.list_top_monthly_spac, parent, false)
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        if (thisdatapreloi[0] != "SPAC NOT FOUND") {
            ...
            PriceFunctions.onclicksetter_topmonthly(holder, "NOT_FOUND", arrayOf(item.stringResourceId1, item.stringResourceId3.toString().plus("%"), item.stringResourceId2), context)
        }
    }
