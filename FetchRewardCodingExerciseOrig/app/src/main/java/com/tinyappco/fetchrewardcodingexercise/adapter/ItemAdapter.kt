package com.tinyappco.fetchrewardcodingexercise.adapter
...
import com.tinyappco.fetchrewardcodingexercise.R

/**
 * Adapter for the [RecyclerView] in [MainActivity]. Displays [FetchRewardsData] data object.
 */
class ItemAdapter(
        private val context: Context,
        private val dataset: List<FetchRewardsData>
